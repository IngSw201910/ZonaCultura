...
class contenidoManualidad(models.Model):
	...
	precioV=models.PositiveIntegerField(default=0,validators=[MinValueValidator(50)])
...
class infoLibro(models.Model):
	...
	PrecioLibro= models.IntegerField(default=0,validators=[MinValueValidator(50)])
...
class Carrito(models.Model):
		...
		multimedia=models.ForeignKey(contenidoMultimedia, on_delete=models.SET_NULL,null=True)
...
class ComentarioMultimedia(models.Model):
	video = models.ForeignKey(contenidoMultimedia, on_delete=models.SET_NULL,null=True)
	califi=models.PositiveIntegerField(default=0, validators=[MaxValueValidator(5.0),MinValueValidator(0,0)])
	comentario=models.TextField(max_length=150,default="")
	usuarioComentador=models.ForeignKey (infousuario,on_delete=models.SET_NULL, null=True)
class Comentario(models.Model):
		manu = models.ForeignKey(contenidoManualidad, on_delete=models.SET_NULL,null=True)
		califi=models.PositiveIntegerField()
		comentario=models.TextField(max_length=150,default="")
		usuarioComentador=models.ForeignKey (infousuario,on_delete=models.SET_NULL, null=True)
